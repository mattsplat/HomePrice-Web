...
import { language, languages, languageSetting, locale, setLanguage, t, type Language } from './i18n'

const { state, rate, reverseRate, converted, refresh, swap } = converter
...
onMounted(refresh)
watch(() => [state.from, state.to], refresh)
