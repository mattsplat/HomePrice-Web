// Generated from the Android app's data/CurrencyCatalog.kt. Keep the two in step.
...
export const favorites: Currency[] = [
...
export const allCurrencies: Currency[] = [
  ...
  { code: 'RSD', name: "Serbian Dinar", symbol: "дн." },
...
export function findCurrency(code: string): Currency | undefined {
  return allCurrencies.find((c) => c.code === code) ?? favorites.find((c) => c.code === code)
}
